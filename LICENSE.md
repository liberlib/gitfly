License Agreement
1. Introduction
This License Agreement ("Agreement") is for the LIBERLIB/GITFLY software project ("Software") and includes specific terms for the use, copying, and distribution of the Software. This Agreement applies to anyone using the Software, and if you do not accept this Agreement, you may not use the Software.

2. Definitions
"Software": The GİTFLY software project that is the subject of this Agreement.
...
this company is a subsidiary of the @hackwinable company
